...
namespace Elision.Foundation.Kernel
{
    public class SitecoreIds
    {
        ...
        public static readonly ID SharedLayoutFieldId = Sitecore.FieldIDs.LayoutField;
        public static readonly ID FinalLayoutField = Sitecore.FieldIDs.FinalLayoutField;
    }
}